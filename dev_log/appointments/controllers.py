    ...
    for week_day in range(7):
        ...
        for halfday in ['Morning', 'Afternoon']:
            ...
            if appointment is None:
                ...
                availabilities[week_day][halfday] = "Already a appointment : {}".format(appointment)

    date_selected = date_selected.isoformat()
    date_start_week = date_start_week.isoformat()
    date_end_week = date_end_week.isoformat()

    return render_template("availabilities.html", availabilities=availabilities, date_selected=date_selected,
                           date_start_week=date_start_week, date_end_week=date_end_week)
